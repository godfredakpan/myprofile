         ...
         <div class="my-auto" id="particles-js">
            <div id="particles-js">
              ...
              <ul class="list-inline list-social-icons mb-0" >
                  ...
                  <li class="list-inline-item">
                      <a href="https://twitter.com/ArcherGodfred" target="_blank">
                  <span class="fa-stack fa-lg">
                    <i class="fa fa-circle fa-stack-2x"></i>
         ...
         <div class="p-lg-5 p-3 skill-cover">
          ...
          <div class="row text-center my-auto "> 
              ...
              <div class="col-md-3 col-sm-6">
               ...
               <div class="col-md-3 col-sm-6">
                  <div class="skill-item">
                      <img src="https://www.meuble-salle-bain-teck.fr/skin/frontend/boilerplate/saniteck/node_modules/gulp-notify/assets/gulp-error.png" width="35%">
            ...
            <div class="col-md-4 col-sm-12 mt-5"> 
              <div class="contact-cont2"> 
                ...
                <ul class="list-inline social-icon-f top-data">
                  ...
                  <li><a href="https://www.twitter.com/ArcherGodfred" target="_empty"><i class="fa top-social fa-twitter" style="color: #4AB3F4; border-color:#4AB3F4;"></i></a></li>
      ...
      <section class=" d-flex flex-column" id="maps">
        <div id="map">
          <div class="map-responsive">
            <iframe width="724" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=uyo%2C%20akwa%20ibom%20state&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
          </div>
        </div>
      </section>
